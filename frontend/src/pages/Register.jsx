        ...
        <div className="bg-white rounded-lg shadow-sm p-8">
          ...
          <div onSubmit={handleSubmit}>
            ...
            <div className="mb-6">
              <label className="flex items-start cursor-pointer">
                ...
                <span className="text-sm text-gray-600">
                  I agree to the{' '}
                  <a href="#" className="text-gray-800 hover:text-gray-900 no-underline">Terms & Conditions</a>
                  {' '}and{' '}
                  <a href="#" className="text-gray-800 hover:text-gray-900 no-underline">Privacy Policy</a>
                </span>
              </label>
            </div>
            ...
            <div className="text-center text-sm text-gray-600">
              ...
              <a href="/login" className="text-gray-800 font-medium hover:text-gray-900 no-underline">
                Login here
              </a>
            </div>
          </div>
