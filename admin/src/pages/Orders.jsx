...
const AdminOrders = () => {
  ...
  // 🔹 which order is being updated (for button/spinner state)
  ...
  // 🔹 Status helpers (using lowercase)
          ...
          <table className="w-full">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {filteredAndSortedOrders.map((order) => {
                ...
                const itemCount = itemsArray.reduce(
                ...
                const pincode =
                  address.pincode || address.zip || address.zipCode;
                ...
                return (
                  <tr key={order._id} className="hover:bg-gray-50 transition">
                    ...
                    {/* 🔹 Items with image + name + quantity */}
